...
SET_WADRR_WEIGHTS = Struct("set_wadrr_weights", UBInt8("version"),
                           UBInt8("type"),
                           UBInt32("length"),
                           UBInt32("seq"),
                           UBInt8("weight"),
                           Bytes("ssid", lambda ctx: ctx.length - 11))
...
PT_TYPES = {PT_BYE: None,
            ...
            PT_SET_WADRR_WEIGHTS: SET_WADRR_WEIGHTS}
